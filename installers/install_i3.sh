...
install_i3 () {
    ...
    echo "deb [signed-by=/usr/share/keyrings/sur5r-keyring.gpg] http://debian.sur5r.net/i3/ $(grep '^VERSION_CODENAME=' /etc/os-release | cut -f2 -d=) universe" | sudo tee /etc/apt/sources.list.d/sur5r-i
    sudo apt update
    sudo apt install i3 i3-wm feh gnome-screenshot j4-dmenu-desktop xautolock xdg-desktop-portal-gtk xdg-desktop-portal-wlr
}
