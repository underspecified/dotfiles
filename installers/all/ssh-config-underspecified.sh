...
# ~/.ssh/config.d/underspecified, where it is picked up by the
...
#     ~/.ssh/config.d/underspecified ssh-config-personal
#
...
bash "${ALL_DIR}/op-config-pull.sh" ssh-config-personal ~/.ssh/config.d/underspecified
